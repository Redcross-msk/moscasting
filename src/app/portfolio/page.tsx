...
export const metadata: Metadata = {
  ...
  description: "Профессиональное фото- и видеопортфолио для актёров по государственным стандартам.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-10 pb-12">
      ...
      <section className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm leading-relaxed text-muted-foreground sm:text-[15px]">
            ...
            <p>
              Мы снимаем и монтируем материал с опорой на общепринятые стандарты подачи: читаемый звук, стабильный кадр,
      ...
      <section className="rounded-xl border border-primary/20 bg-primary/[0.04] p-6 sm:p-8">
        <h2 className="text-lg font-semibold">Государственные стандарты и сервис</h2>
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground sm:text-[15px]">
          Работаем прозрачно: фиксируем договорённости по срокам и формату, соблюдаем требования к персональным данным.
