  ...
  return (
    <div className="space-y-2 border-b border-border pb-5 text-foreground">
      ...
      <p className="text-xs text-muted-foreground">
        Сведения об операторе и реквизиты подлежат заполнению после регистрации юридического лица или
        индивидуального предпринимателя в установленном законом порядке. До заполнения соответствующие поля обозначены
        прочерком (—).
      </p>
    </div>
  );
